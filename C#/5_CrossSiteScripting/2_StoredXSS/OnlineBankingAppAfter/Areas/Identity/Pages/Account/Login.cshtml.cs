        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (await _userManager.IsInRoleAsync(user, Role.PendingCustomer))
                    {
                        await _userManager.RemoveFromRoleAsync(user, Role.PendingCustomer);
                        await _userManager.AddToRoleAsync(user, Role.ActiveCustomer);
                    }
